...
const TopPerformersCard = () => {
    ...
    useEffect(() => {
        const fetchTopPerformers = async () => {
            try {
                ...
                const res = await axios.get(`${API_URL}/performance/top`, config);
    ...
    if (loading) {
        return (
            <div className="card h-[400px] p-8 animate-pulse overflow-hidden">
                <div className="h-8 bg-slate-100 rounded-xl w-1/3 mb-8"></div>
        ...
        <div className="card p-8 relative overflow-hidden">
            <div className="flex justify-between items-center mb-8 relative z-10">
                ...
                <div className="flex items-center space-x-2">
                    <div className="flex items-center space-x-2 px-3 py-1 bg-slate-50 rounded-full border border-slate-100 shadow-sm">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="text-right">
                                        ...
                                        <div className="w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden mt-1.5">
                                            <div
                                                className={`h-full rounded-full transition-all duration-1000 ${performer.score > 80 ? 'bg-emerald-500' : performer.score > 60 ? 'bg-amber-500' : 'bg-red-500'}`}
