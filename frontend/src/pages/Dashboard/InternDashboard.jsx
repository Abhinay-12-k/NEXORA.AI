        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-8">
                    {/* AI Feedback Section */}
                    <div className="card">
                        <div className="heading-block border-none shadow-none rounded-none border-b border-slate-100 bg-slate-50/50 mb-8 -mx-6 -mt-6">
                            ...
                            <button
                                ...
                                disabled={aiLoading}
                                className="btn btn-primary text-sm px-4 py-2 relative z-10"
                            >
                                {aiLoading ? (
