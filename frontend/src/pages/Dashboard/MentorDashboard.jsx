    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            <header className="page-header flex justify-between items-center">
                <div>
                    <h1 className="page-title">Mentor Command</h1>
                    <p className="page-subtitle uppercase tracking-[0.2em] text-[10px] font-black opacity-70">Resource & Performance Management</p>
                </div>
                <button
                    onClick={() => setShowCreateModal(true)}
                    className="btn btn-primary px-6 py-3 rounded-2xl shadow-xl shadow-blue-500/20 relative z-10"
                >
                    ...
                    <div className="heading-block">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="input-field pl-11 py-2 text-sm w-48 rounded-xl border-slate-100 bg-slate-50/50 hover:bg-white focus:bg-white transition-all shadow-none"
                            />
                        </div>
                    </div>
